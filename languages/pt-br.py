...
'Errors': 'Erros',
'Errors in form, please check it out.': 'Erros no formulário, tente novamente.',
...
'O Preço Final não pode ser ZERO': 'O Preço Final não pode ser ZERO',
'O preço Final não pode ser ZERO': 'O preço Final não pode ser ZERO',
...
'Tem que ser maior que ZERO': 'Tem que ser maior que ZERO',
